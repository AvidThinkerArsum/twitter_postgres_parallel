...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/AvidThinkerArsum/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/AvidThinkerArsum/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/AvidThinkerArsum/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/AvidThinkerArsum/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/AvidThinkerArsum/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/AvidThinkerArsum/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |      `7m55.853s`          |          `57.16s`         | 
| `pg_normalized_batch`  |      `1m40.906s`          |          `14.31s`         | 
| `pg_denormalized`      |      `0m17.253s`          |          `3.94s`          | 
